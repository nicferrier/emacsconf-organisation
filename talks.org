...
** Book raffle
   ...
   http://emacsconf.org/proposals/42
   ...
   I will try and have the titles sent from within the UK. In any case,
   I'll need a contact person at the venue as an adress. Not much
   storage space will be needed, I expect a dozen books or so (mhuber)

   Also, I will have a raffle for vouchers from my employer (Admin
   Magazine, Linux (Pro) Magazine, Ubuntu User etc.) (mhuber)
